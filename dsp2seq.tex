...
\begin{slide}[\slideopts,toc={One Pole Filter}]{Consider the \emph{One-Pole Recursive Digital Filter}}
...
\mpitem Retrieve similar vectors using a \emph{matched inner product} $\wv^T\xv > b$,\\
        for some suitable threshold $b$ (That's a simulated neuron! (``Perceptron''))
\end{itemize}
\end{slide}
