...
0 & 0 & \cdots & 0 & \onevec & \av_n & \cdots & 0 \\
\vdots & \vdots & \ddots & \vdots & \vdots & \vdots & \ddots & \vdots \\
0 & 0 & \cdots & 0 & \onevec & 0 & \cdots & \av_n
\end{pmatrix}
\quad
\mathbf{B_{TM}} = \begin{pmatrix} \beev_n \\ 0 \\ 0 \\ \vdots \\ 0 \end{pmatrix}
\]

\end{slide}

\begin{slide}[\slideopts,toc={Plan}]{Reasonable Next Steps}
  \vspace{-1em}
  \begin{itemize}
    \mpitem Try to improve \textbf{Mamba}[-2] on small synthetic datasets testing \emph{memory}
    \begin{itemize}
      ...
      \mpitem Initial \emph{biases} at $\zv$ versus $2/N$ etc.
    ...
    \end{itemize}
    \mpitem Publish on Arxiv and GitHub, advertise on ``AI social media'' and blog
    ...
    \begin{itemize}
      ...
      \mpitem Four papers started
    \end{itemize}
    \mpitem Feel free to take on any of these so I don't have to! (And LMK, please)
  \end{itemize}
\end{slide}
