...
\mpitem Set $\geev = \onev$ and $\peev = \onev$ to make $\yv(n)$ a \emph{sum of all input vectors} (``integrator'')
...
\\
$
\cv_{kj}\xv_j = \left[\left(\sum_{m\in \Rscr_k}\xv_m\right)^T \xv_j\right]\xv_j
$
\\
\maybepause
