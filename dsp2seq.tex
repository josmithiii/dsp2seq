...
\newcommand{\theTitle}{Inventing Modern Sequence Models as Signal Processors}
...
\begin{itemize}
  ...
  \mpitem Feedback matrix $\Amtx$ has been typically \emph{diagonal} since 2022 (see ``S4D'')\\
