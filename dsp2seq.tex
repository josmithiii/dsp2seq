...
Previous versions of this talk were aimed at
\begin{enumerate}
...
\begin{enumerate}
  \mpitem[3.] Signal-processing students and professionals,\\
              assumed to know more DSP than machine learning
\end{enumerate}
...
\begin{slide}[\slideopts,toc={One Pole Filter}]{Challenge Problem: Can we make an \emph{Associative Memory} out of a \emph{Vectorized One-Pole Filter}}
\vspace{-2em}
