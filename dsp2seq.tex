...
%    \begin{enumerate}
      ...
      $
      \mpitem See Cayley-Dickson Construction for $2^k-1$ angles, $k=1,2,3,\ldots$
      ...
      \mpitem Find suitable method of \emph{constrained gradient descent}
      \mpitem Use \emph{reserved translational dimension} instead (``TraPE'')
