...
\begin{slide}[\slideopts,toc={Courses}]{\htmladdnormallink{Courses Developed for CCRMA}{http://ccrma.stanford.edu/~jos/\#books}}
%\vspace{-1em}
...
% 421
\qquad\;
\vcenteredhbox{\resizebox{0.2\textwidth}{!}{\includegraphics{eps/outer_ear.eps}}}\\
...
%\resizebox{0.1\twidth}{!}{\includegraphics{eps/outer_ear.eps}}
